...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>alamat kamu</h3>
      <input type="text" class="box" placeholder="bangunan no." required maxlength="50" name="building">
      ...
      <input type="text" class="box" placeholder="nama daerah" required maxlength="50" name="state">
      <input type="text" class="box" placeholder="nama negara" required maxlength="50" name="country">
      <input type="number" class="box" placeholder="kode post" required max="999999" min="0" maxlength="6" name="pin_code">
