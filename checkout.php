...
<div class="heading">
   <h3>checkout</h3>
   <p><a href="home.php">rumah</a> <span> / checkout</span></p>
</div>
...
<form action="" method="post">
   ...
   <div class="user-info">
      ...
      <select name="method" class="box" required>
         ...
         <option value="credit card">Atm</option>
         <option value="paytm">GoPay</option>
         <option value="paypal">Dana</option>
      </select>
      <input type="submit" value="pesan" class="btn <?php if($fetch_profile['address'] == ''){echo 'disabled';} ?>" style="width:100%; background:var(--red); color:var(--white);" name="submit">
   </div>
